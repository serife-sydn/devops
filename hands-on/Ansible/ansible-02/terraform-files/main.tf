...
resource "null_resource" "config" {
  ...
  connection {
    ...
    type = "ssh"
    user = "ec2-user"
    private_key = file("/home/ec2-user/${var.mykey}.pem")
    # Do not forget to define your key file path correctly!
  }

  provisioner "file" {
    source = "./ansible.cfg"
    destination = "/home/ec2-user/terraform-files/ansible.cfg"
  }

  provisioner "file" {
    # Do not forget to define your key file path correctly!
    source = "/home/ec2-user/${var.mykey}.pem"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo node3 ansible_host=${aws_instance.nodes[3].private_ip} ansible_ssh_private_key_file=/home/ec2-user/${var.mykey}.pem ansible_user=ubuntu >> inventory.txt",
